...
/**
 * Sends a plain free-text WhatsApp message — used for the Confirm/Cancel acknowledgement reply
 * (see app/api/whatsapp/webhook/route.ts). Unlike sendOrderConfirmationWhatsApp, this doesn't need
